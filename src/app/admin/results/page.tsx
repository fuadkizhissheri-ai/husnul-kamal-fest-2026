                    ...
                    <td className="py-3.5 px-6 text-right">
                      <div className="flex items-center justify-end space-x-2">
                        <button
                          ...
                          className="px-2.5 py-1 rounded-lg bg-[#C8A86B]/20 text-[#9E741D] dark:text-[#C8A86B] font-bold text-[10px] hover:bg-[#C8A86B]/30 flex items-center space-x-1"
                        ...
                        <button
                          ...
                          className="p-1.5 rounded-lg bg-slate-100 dark:bg-white/10 hover:bg-slate-200 dark:hover:bg-white/20 text-slate-700 dark:text-white"
                          title="Edit Result"
                        >
