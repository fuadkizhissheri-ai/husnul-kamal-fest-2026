      ...
      <div className="max-w-7xl mx-auto luxury-glass px-3 sm:px-6 py-2.5 sm:py-3.5 flex items-center justify-between shadow-luxury dark:shadow-luxury-dark">
        ...
        <div className="flex items-center space-x-1.5 sm:space-x-3 shrink-0">
          ...
          <a
            ...
            className="flex p-2 sm:p-2.5 rounded-full bg-emerald-500/10 hover:bg-emerald-500/20 border border-emerald-500/30 text-emerald-600 dark:text-emerald-400 hover:scale-105 transition-all duration-300 items-center justify-center cursor-pointer"
